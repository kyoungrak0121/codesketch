		...
		guiStyles: {
			...
			bootstrap4: {
				...
				dialog: {
					...
					content: "modal-content",
					hr: "hidden",
					closeButton: "btn btn-xs btn-outline-dark",
					fmButton: "btn btn-outline-dark",
					dataField: "form-control",
					viewCellLabel: "",
					viewLabel: "control-label",
					viewCellData: "",
				...
				gridError: "alert alert-danger",
				gridErrorText: "sr-only",
				titleButton: "btn btn-xs btn-outline-dark",
				actionsDiv: "",
				actionsButton: "btn btn-xs btn-outline-dark",
				toolbarUpper: "",
				toolbarBottom: "",
				pager: {
					pager: "card-footer",
				...
				searchDialog: {
					...
					elem: "form-control",
					operationGroup: "form-inline",
					addRuleButton: "btn btn-xs btn-outline-dark",
					deleteRuleButton: "btn btn-xs btn-outline-dark",
					operationSelect: "form-control",
					addGroupButton: "btn btn-xs btn-outline-dark",
					deleteGroupButton: "btn btn-xs btn-outline-dark"
				},
				searchToolbar: {
					menu: "dropdown-menu",
					operButton: "btn btn-xs btn-outline-dark",
					clearButton: "btn btn-xs btn-outline-dark"
				},
				top: "ui-jqgrid-bootstrap-corner-top",
				bottom: "ui-jqgrid-bootstrap-corner-bottom",
				resizer: "ui-jqgrid-bootstrap"
