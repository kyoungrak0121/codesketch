...
options.scrollBar=options.scrollBar||options.hybrid;setOptionsFromDOM();prepareDom();setAllowScrolling(!0);setAutoScrolling(options.autoScrolling,'internal');responsive();setBodyClass();resizeHandler();if(document.readyState==='complete'){scrollToAnchor()}
